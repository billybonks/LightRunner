...
void Player::jump(float multiplier){
	...
	CCArray* jumpframes = CCArray::create(CCSpriteFrameCache::sharedSpriteFrameCache()->spriteFrameByName("4.png"),CCSpriteFrameCache::sharedSpriteFrameCache()->spriteFrameByName("5.png"),CCSpriteFrameCache::sharedSpriteFrameCache()->spriteFrameByName("6.png"),CCSpriteFrameCache::sharedSpriteFrameCache()->spriteFrameByName("7.png"),CCSpriteFrameCache::sharedSpriteFrameCache()->spriteFrameByName("8.png"),NULL);
